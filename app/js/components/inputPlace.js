	...
	render(){
		...
		return (<div id="inner">
				<div className="checkInfo">
					<input id = 'area' type={this.state.type} placeholder='Коды товаров' onChange={this.inputHandler.bind(this)} onKeyDown={this.enterPress()} value={this.state.inputValue}/>
					<a id="check" onClick={this.state.actionHandler.bind(this, this.state.inputValue)}>Найти</a>
				</div>
				<ActionContainer found={this.state.found} className='positionContainer'/>
				<a className='openTabs' onClick={this.openTabs.bind(this)}>Открыть</a>
